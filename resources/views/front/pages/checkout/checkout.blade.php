                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <select class="form-select" id="shipping_country" name="shipping_country">
                                        <option>{{ __('Select the Country') }}</option>
                                        @foreach (country() as $cnt)
                                            <option value="{{ $cnt }}">
                                                {{ $cnt }}
                                            </option>
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            {{-- <li class="list-group-item">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <p class="fw-bold mb-0"><span> {{ currencyConverter(\Cart::subtotal() + allsetting()['shipping_charge'] + tax_amount(\Cart::subtotal()) - Session::get('CouponAmount')) }}</span></p>
                                </div>
                            </li> --}}
                        </ul>
